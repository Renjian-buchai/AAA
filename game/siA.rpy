...
label BsiA13: 
    ...
    show shkprb at left with dissolve
...
label BwA18:
    ...
    show asi confused with dissolve 
    a "Huh?" 
    ...
    show asi awkward with dissolve 
...
label BwA19: 
    ...
    hide asi contemplative with dissolve 
...
label BwA20: 
    ...
    hide ina curious with dissolve 
    ...
    hide ina mischievous with dissolve 
    show ina disdainful with dissolve 
    a "Eww." 
    ...
    hide ina disdainful with dissolve 
    show ina annoyed with dissolve 
    ...
    hide ina annoyed with dissolve 
    show ina disdainful with dissolve 
...
label BwA21: 
    ...
    hide asi sarcastic with dissolve 
    show asi mischievous with dissolve 
    a "Is it so~?" 
    "She {i}definitely{/i} doesn't believe me." 
    u "Hehe." 
    u "So,{w=.1}  what's your point?" 
    hide asi mischievous with dissolve 
    show asi contemplative with dissolve 
    a "You know..." 
    ...
    hide asi contemplative with dissolve 
    show asi flustered with dissolve 
    "[a] blushed." 
    a "Stop it." 
...
label BwA22: 
    ...
    hide asi flustered with dissolve 
    show asi annoyed with dissolve 
...
label LBwA18: 
    ...
    hide asi excited with dissolve 
    hide Emcee with dissolve 
    scene bgstage with fade 
    "She pulled me along as she jumped onto the stage." 
    show Emcee with dissolve 
...
label sxA17: 
    ...
    show a depressed   with dissolve
    show skpr at left with dissolve
    a "Haih,{w=.1} how sad." 
    a "It's your turn." 
    "Shopkeeper" "Go on,{w=.1} impress your girlfriend." 
    hide a depressed with dissolve
    show a flustered with dissolve  
...
label LsxA19: 
    ...
    show asi apologetic with dissolve
    a "Thanks..." 
    u "No problem." 
    a "I'll pay you back." 
    u "No need." 
    ...
    "It's late,{w=.1} so I want to go home." 
    hide asi apologetic with dissolve
    show asi happy with dissolve
    scene bgchristmasmarket with fade 
    u "Should we go home now?" 
    hide asi happy with dissolve
...
label sxA21: 
    ...
    hide asi angry  with dissolve
    show asi scared with dissolve
    ...
    hide asi relieved with dissolve
    show asi happy with dissolve
