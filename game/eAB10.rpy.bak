label eAB10: 
    ...
    "At least, a true partying student who's drinking at all times of the day." 
    hide a disdainful 
    show a confused 
...
label eAB11: 
    ...
    u "Oh." 
    "What's the point of mentioning it to me?" 
    "It's not like I need to know what she's drinking." 
    hide a excited 
    show a curious 
    a "What about you?" 
    u "Gluhwein." 
    "There was a stall that sold it at the end of the district, based on what I can see from here." 
    hide a excited 
    show a confused  
    u "Glue-wine?" 
    u "What's that?" 
...
label eAB12: 
    ...
    a "So, are you sure you weren't plotting anything?" 
